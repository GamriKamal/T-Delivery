...
public class AuthenticationService {
    ...
    public JwtAuthenticationResponse signUp(SignUpRequest request) {
        ...
        try {
            ...
            throw new FieldAlreadyExistsException(e.getLocalizedMessage());
        } catch (Exception e) {
    ...
    public JwtAuthenticationResponse signIn(SignInRequest request) {
        try {
            ...
            log.error("An error occurred while signing up " + e.getLocalizedMessage());
            throw new RuntimeException("An internal server error occurred: " + e.getLocalizedMessage());
        }
    }
